...
| Enum key | Trained on | Benchmarked on | EPE |
|----------|-----------|----------------|-----|
| `C_T_V2` | FlyingChairs + FlyingThings3D | Sintel Clean | 1.38 |
| `C_T_V2` | FlyingChairs + FlyingThings3D | Sintel Final | 2.72 |
| `C_T_SKHT_V2` (**DEFAULT**) | +Sintel fine-tune | Sintel-Test Clean | 1.82 |
| `C_T_SKHT_V2` (**DEFAULT**) | +Sintel fine-tune | Sintel-Test Final | 3.07 |
...
| Enum key | Trained on | Notes |
|----------|-----------|-------|
| `C_T_V2` (**DEFAULT**) | FlyingChairs + FlyingThings3D | ~5× fewer params than Large |
